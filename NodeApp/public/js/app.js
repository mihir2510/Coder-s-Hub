...
app.controller('AppCtrl', function($scope) {
    ...
    ;
    $scope.htmlVariable = "<p style=\"text-align: center;\"><i>\"CodersHub is a programming judge that helps you improve your coding skill. Thanks to Judge0 API, it supports over 20 languages such as c, c++, python, java blah blah blah. You can register for free by click <a href=\"/register\">here</a> and just fill username password and email. Sounds easy, isn't it? It's also open source project on Github. Feel free to contribute!\"</i></p> \
    <p><b>Welcome to CodersHub!</b> This problem template contains some markup examples for problem writer.<br></p> \
    <ul> \
